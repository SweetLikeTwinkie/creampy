...
def is_port_in_use(port, host="127.0.0.1"):
    ...
    - If binding fails, the port is considered in use.
...
def check_connectivity():
    """
    Checks connectivity across multiple protocols.

    - Tries HTTP and HTTPS connections using requests.
    - Resolves DNS using dnspython.
    - Sends ICMP echo requests using ping3.

    Returns:
        str: The first working protocol URL (e.g., "https://c2server.com").
        None: If all protocols fail.
    """
