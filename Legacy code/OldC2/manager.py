...
from protocols.http_server import run_http_server, run_https_server
from protocols.smb_server import start_smb_server
from protocols.dns_server import start_dns_server
from protocols.icmp_server import start_icmp_server
...
class ProtocolManager:
    ...
    async def start_all(self):
        ...
        - Sets `stop_event` to False before starting thread-based protocols.
    ...
    async def stop_all(self):
        ...
        - Sets `stop_event` to signal thread-based protocols to terminate.
        - Cancels all asyncio-based tasks.
        - Ensures a short delay to allow thread-based protocols to exit gracefully.
        - Resets state variables to allow for future restarts.
        """
        if not self.running:
